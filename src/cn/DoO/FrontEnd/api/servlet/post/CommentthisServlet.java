...
public class CommentthisServlet {
	...
	public void commentthis(HttpServletRequest request, HttpServletResponse response)
		...
		// 如果token为空显示
		if (token == null || token.equals("") || postid == null || postid.equals("") || commenttext == null
				|| !VerifyUtils.isInteger(postid)) {
		 ...
		 * =========================
		 */
		if (!postDaoImpl.isNotComment()) 
		{
			print(out, data, "-4", "网站禁止评论");
			return;
		}
		/**
		 * =========================
