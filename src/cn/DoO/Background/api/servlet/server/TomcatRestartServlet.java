...
public class TomcatRestartServlet {
	...
	CheckingPostDaolmpl checkingPostDaolmpl = new CheckingPostDaolmpl();
		public void Restart(HttpServletRequest request, HttpServletResponse response) throws ClassNotFoundException, SQLException, IOException {
		// 获取token
			...
			
		{
			...
			checkingPostDaolmpl.addLog(rootid, System.currentTimeMillis(), "重启Tomcat", ip, "8");//写入
