...
public class AdvertDao {
	 ...
	 */
	public  List<Map<String, Object>> findAll(String word, int page, int size) throws ClassNotFoundException, SQLException {
	 ...
	 */
	public void delAdvertById(String aid) throws ClassNotFoundException, SQLException, FileNotFoundException, IOException {
	 ...
	 * @throws ClassNotFoundException 
	 */
	public void saveAdverInfo(String acontext, String aimg) throws ClassNotFoundException, FileNotFoundException, SQLException, IOException {
