...
public class RootDaoImpl {
	...
	public Map<String, Object> getRootById(String rootid) throws ClassNotFoundException, SQLException {
		...
		data = dao.executeQueryForMap(sql, new int[] { Types.INTEGER }, new Object[] { rootid });
		return data;
	}
	...
	public List<Map<String, Object>> getAllUserlogs() throws ClassNotFoundException, SQLException {
		List<Map<String, Object>> data = dao
				.executeQueryForList("SELECT * FROM userlogin ORDER BY userloginid  DESC LIMIT 5");
		return data;
	}
	...
	public List<Map<String, Object>> getAllSearchFrom5() throws ClassNotFoundException, SQLException {
		List<Map<String, Object>> data = dao
				.executeQueryForList("select * ,count(*) as c from shistory group by word ORDER BY c DESC LIMIT 5");
		return data;
	}
