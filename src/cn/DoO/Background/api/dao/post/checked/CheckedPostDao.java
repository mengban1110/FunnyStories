...
//		System.out.println(jsonObject);
	 ...
	 * @throws SQLException
	 */
	public List<Map<String, Object>> findAllByWord(int page, int size, String word) throws ClassNotFoundException, SQLException {
	 ...
	 * @throws ClassNotFoundException 
	 */
	public void commendPost(String postid) throws ClassNotFoundException, FileNotFoundException, SQLException, IOException {
	 ...
	 * @throws IOException
	 */
	public void deletePost(String postid) throws ClassNotFoundException, FileNotFoundException, SQLException, IOException {
	 ...
	 * @throws SQLException
	 */
	public List<Map<String, Object>> getCommendByPostId(String postid,String word,int page, int size) throws ClassNotFoundException, SQLException {
	 ...
	 * @throws ClassNotFoundException 
	 */
	public void deleteComment(String commentid) throws ClassNotFoundException, FileNotFoundException, SQLException, IOException {
