 ...
 * <p>
 * 时间相关 : <br>
 * 1 : 根据毫秒返回具体时间---MillToHourAndMin(String lo)<br>
 * 2 : 根据毫秒返回时间 大于7天返回具体时间、大于1天返回几天、小于一天返回小时---MillToTime(String lo)<br>
 * 3 : 判断是否超过指定分钟---differTime(String strTime, int min)<br>
 * 4 : 获取当前时间 格式：yyyyMMdd---CurrentyyyymmddTime()<br>
